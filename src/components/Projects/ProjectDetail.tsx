...
import { ArrowLeft, ExternalLink, AlertTriangle, Target, GitBranch, Calendar, Save, Edit2, MessageSquare, CheckCircle, Clock, FileText, BarChart3, Info } from 'lucide-react';
          ...
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-4 mb-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {Object.entries(project.pipeline.phases).map(([phase, status]) => (
                <div key={phase} className="text-center p-2 rounded-lg bg-gray-750">
                  <span
            ...
            {projectThreads.length === 0 ? (
              ...
              <div className="space-y-3">
                {projectThreads.slice(0, 5).map((thread, i) => (
                  <div key={thread.threadId || i} className="border-l-2 border-gray-600 pl-3 py-1">
                    <div className="flex items-center justify-between">
